...
namespace SYNARMOSMA {
  ...
  class Solver {
   protected:
    ...
    virtual double compute_dependencies();
    ...
    virtual void random_initialization(double,double);
   ...
   public:
    /// An empty constructor that does nothing but which is useful for derived classes when the dimension isn't known at instantiation. 
    Solver();
